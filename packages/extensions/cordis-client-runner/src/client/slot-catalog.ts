...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Details-panel body tabs; the shell owns the active id and dispatches one entry.',
    doc: 'Details-panel body tabs; the shell owns the active id and dispatches one entry.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'details\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-browser BrowserView id \'browser\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:60',
  },
  {
