...
| [browser.md](browser.md) | the browser automation seam: provider selection, per-session CLI execution, dashboard ownership, and the model-facing feed projection |
